...
import { addTodo, deleteTodo, updateTodo } from "../../app/slices/todos.slice";
import { useAddTodoMutation, useFetchTodosQuery } from "../../app/slices/todosApi";
...
function Todos() {
    ...
    const handleAdd = () => {
        if (title === "") {
            alert("Tiêu đề không dc để trống");
            return;
        }
        addTodo(title)
        setTitle("");
    ...
    const handleDelete = (id) => {
        // // TODO : Thêm comfirm trước khi xóa
